...
export default {
  ...
  "camera.hint": "Face the camera straight on, with your head inside the oval.",
  "camera.private": "The camera picture stays in this browser tab.",
  "camera.capture": "Capture",
  "camera.retake": "Retake",
  "camera.use": "Use this photo",
  "camera.taken": "The photo you took",
  "camera.denied": "The browser was not allowed to use the camera. Allow it from the icon in the address bar and try again, or choose a photo instead.",
  "camera.none": "No camera was found on this computer.",
  "camera.busy": "The camera is in use by another app. Close it and try again.",
  "camera.failed": "The camera could not be started.",
  "camera.retry": "Try again",
  "camera.fallback": "Choose a photo instead",
