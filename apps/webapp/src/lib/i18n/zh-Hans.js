...
export default {
  ...
  "camera.title": "拍一张",
  "camera.close": "关闭",
  "camera.starting": "正在打开摄像头…",
  "camera.hint": "正对摄像头，把头放在椭圆框内。",
  "camera.private": "摄像头画面只留在这个浏览器标签页里。",
  "camera.capture": "拍照",
  "camera.retake": "重拍",
  "camera.use": "使用这张",
  "camera.taken": "你拍的照片",
  "camera.denied": "浏览器没有获得摄像头权限。请点地址栏里的图标允许后重试，或改为选择照片。",
  "camera.none": "这台电脑上没有找到摄像头。",
  "camera.busy": "摄像头正被其他应用占用。关闭后再试一次。",
  "camera.failed": "无法打开摄像头。",
  "camera.retry": "重试",
  "camera.fallback": "改为选择照片",
